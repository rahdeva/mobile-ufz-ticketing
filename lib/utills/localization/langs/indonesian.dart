const Map<String, String> id = {
  ...
  'txt_flow_login_enter_email': 'masukan email',
  'txt_flow_login_password': 'Password',
  'txt_flow_login_enter_password': 'masukan password',
  'txt_flow_login_language': 'Bahasa',
  'txt_flow_login_change_language': 'Pilih Bahasa',
  'txt_flow_login_forgot_password': 'Lupa Password?',
  'txt_flow_login_login': 'Masuk',
  ...
  'txt_flow_forgotpass_input_new_password': 'Masukkan Password Baru',
  'txt_flow_forgotpass_enter_password': 'input password',
  'txt_flow_forgotpass_reenter_new_password': 'Masukkan Ulang Password Baru',
  'txt_flow_forgotpass_reenter_password': 'ulang input Password',
  'txt_flow_forgotpass_password_min_chars': 'Minimal 8 karakter',
  'txt_flow_forgotpass_reset_password': 'Reset Password',
  'txt_flow_forgotpass_password_changed': 'Password Anda telah berhasil diperbarui.',
